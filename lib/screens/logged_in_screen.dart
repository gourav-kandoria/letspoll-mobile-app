...
import 'package:lets_pole/screens/question.dart' as prefix1;
import 'package:lets_pole/screens/voterlist.dart' as prefix0;
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      builder: (context) {
        ...
        return Poll.create("Thegreatpollid", "Thegreatuserid",
            "The Great Poll Name");
      },
      child: Scaffold(
        body: list[tab_index],
        appBar: AppBar(title: Text("Lets Poll"),),
